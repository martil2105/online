...
model_name = "n100N700m198l10"
logdir = Path("tensorboard_logs", f"train_rho{rhos}")
print(logdir)
...
data = GenDataMeanAR(num_repeats, stream_length, cp=None, mu=(mu_L, mu_L), sigma=sigma, coef=rhos)
...
plt.xlim(0.8,1.0)
plt.legend(['Detection Delay', 'Detection Delay CUSUM', 'Detection Delay Logit CUSUM'])
...
plt.plot(false_alarm_rates, fp_cusum, 'o-', linewidth=2, markersize=6, color='green')
plt.plot(false_alarm_rates, fn_cusum, 'o-', linewidth=2, markersize=6, color='yellow')
plt.plot(false_alarm_rates, fp_logit_cusum, 'o-', linewidth=2, markersize=6, color='purple')
plt.plot(false_alarm_rates, fn_logit_cusum, 'o-', linewidth=2, markersize=6, color='orange')
plt.xlim(0.8,1.0)
plt.xlabel('Percentile Threshold')
plt.ylabel('Number of False Positives')
plt.title('False Positives vs Threshold')
plt.legend(['False Positives', 'False Negatives', 'False Positives CUSUM', 'False Negatives CUSUM', 'False Positives Logit CUSUM', 'False Negatives Logit CUSUM'])
plt.grid(True)
...
plt.savefig(f"thresholdsimulatedrhoeddorg.png")
plt.tight_layout()
#plt.show()
