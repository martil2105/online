...
def process_streams(data, true_taus, model, window_length, thresholds):
...
detection_delay_alt, run_length_alt, fp_alt, fn_alt, tp_alt, tn_alt = process_streams(data_alt, true_tau_alt, model, window_length, thresholds)
