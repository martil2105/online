...
data_null = GenDataMean(N_null, stream_length, cp=None, mu=(mu_L, mu_L), sigma=sigma)[0]
num_streams = data_alt.shape[0]
window_length = 100
num_windows = len(data_null) - window_length + 1
for i in range(num_windows):
    window_data = data_null[i:i+window_length]
